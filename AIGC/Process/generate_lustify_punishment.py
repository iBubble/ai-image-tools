...
def generate_lustify_punishment():
    ...
    checkpoint = "Lustify_SDXL.safetensors"
    
    for i, stage in enumerate(stages):
        filename = f"xiao_ni_{timestamp}_{stage['desc']}.jpg"
        save_path = os.path.join(target_dir, filename)
        
        print(f"正在生成 Lustify SDXL 惩罚: {filename}...")
        try:
            ...
            print(f"Lustify 生成出现错误: {e}")

if __name__ == "__main__":
    generate_lustify_punishment()
