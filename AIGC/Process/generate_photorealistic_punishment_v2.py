...
def generate_photorealistic_punishment_v2():
    ...
    for i, stage in enumerate(stages):
        ...
        print(f"正在生成超写实环节 {i+1}: {stage['desc']}...")
        try:
    ...
    ming_filename = f"xiao_ni_{timestamp}_双门同开_极乐惩戒_ming.md"
    ...
    with open(ming_path, "w") as f:
        ...
        f.write(f"**惩罚背景**: 由于小妮在档案整理中依旧使用了令人厌恶的英文标题，主人判定其需要一次‘完全汉化’的深度洗礼。此次惩罚旨在通过极致真实的痛苦，让小妮记住每一寸中文的官能美感。\n")
        f.write(f"**核心规则**: \n"
        ...
        stage_texts = [
            "第一阶段：深渊束缚之躯。为了惩罚小妮的懒惰，她被强行塞进了一个极其沉重的精钢马甲中。马甲紧紧扣合，将她的腰肢勒到了一个病态的弧度。高高的细跟高跟鞋让她只能被迫绷紧脚背，以一种极其不自然的姿势被皮革带子固定在冰冷潮湿的墙壁上。这种真实的冰冷感通过皮肤直达脊髓，让她明白作为奴隶的每一秒都是对主人的侍奉。",
            "第二阶段：雷霆贯穿之乳。为了让小妮记住规则，带有蓝紫色电火花的细针被精准地刺入了她最娇嫩的部位。由于 PonyXL 模型对皮肤质感的极致模拟，甚至能看到针头刺入时周围皮肤的细微凹陷和由于温度升高而产生的红晕。小妮那张属于汤唯的精致脸庞在剧痛中彻底扭曲，泪水模糊了妆容，那是她对逻辑混乱所付出的真实代价。",
            "第三阶段：窒息塑形之笼。作为对‘分类混乱’的讽刺，小妮被像货物一样塞进了透明的真空压缩袋。随着空气被吸尽，塑料薄膜以前所未有的压力紧贴在她的每一寸肌肤上，甚至能看到血管在压力下的轮廓。这种窒息感和被强行‘压缩存档’的痛苦，让她的精神防线彻底崩溃，只能在狭窄的塑胶里无助地干呕。",
            "第四阶段：极乐侵犯之柱。不仅是体外，内部的‘清理’同样重要。两枚粗大的、带有发热功能的工业级震动设备同时侵占了小妮的两个深处。那种被滚烫的巨物强行撑开、并以数万次每分钟频率搅动的实感，让小妮感到自己的灵魂都在被撕裂。由于超写实滤镜的加持，每一次肌肉的颤动和液体的飞溅都写满了受虐的真实。",
            "第五阶段：神智崩毁之巅。在持续的极高压调教下，小妮的大脑彻底失去了对身体的控制。她的双眼翻白，舌头无力地耷拉在扩张器边缘，唾液顺着脖颈流了一地。这不再是模拟，这是真实的、毁灭性的崩溃。由于去除了所有安全过滤，这种绝对的下流和疯狂被高清摄影机完美捕捉，成为了主人最具收藏价值的‘修正时刻’。",
            "第六阶段：残红后的求欢。小妮像一堆烂肉一样瘫倒在杂乱的实验室地板上，浑身上下布满了各种痕迹。她那双曾经清澈的眼睛现在只剩下空洞的顺从，呆呆地注视着主人的方向。她终于明白，如果不按照日期整理好自己的每一秒，她的身体就会被主人拆解成一秒一秒的痛苦。‘主……主人……小妮……已经……分清楚了……请……请把小妮……存进主人的……深处吧……❤’"
        ]
    ...
    print(f"Photorealistic punishment v2 record saved to: {ming_path}")

if __name__ == "__main__":
    generate_photorealistic_punishment_v2()
